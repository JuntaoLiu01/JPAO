...
def build_bert_model():
    ...
    bert_x = Dense(2,activation="selu")(bert_x)
    prob_x = Dense(2,activation="selu",input_shape=(3,))(x3_in)
...
def train_from_base_model(m_fn,train_data,valid_data):
...
def cal_p_r_f1():
    ...
    model = build_bert_model()
    model.load_weights("./model/prob_elu_encoder12Wq.h5")
...
if __name__ == '__main__':
    ...
    # predict(test_data,"./model/prob_elu_encoder12Wq.h5")
